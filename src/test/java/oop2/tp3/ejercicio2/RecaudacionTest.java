...
public class RecaudacionTest {
    CSVHelper csvHelper = new CSVHelper("src/main/resources/data.csv");
    @Test
    public void testWhereGivenCompany() throws IOException {
        Map<String, String> options = new HashMap<String, String>();
        options.put("company_name", "Facebook");
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 7);
    }
    ...
    public void testWhereGivenCity() throws IOException {
        ...
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 3);
    }
    ...
    public void testWhereGivenState() throws IOException {
        ...
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 873);
    }
    ...
    public void testWhereGivenRound() throws IOException {
        Map<String, String> options = new HashMap<String, String>();
        options.put("round", "a");
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 582);
    }
    ...
    public void testMultipleOptions() throws IOException {
        ...
        options.put("round", "a");
        options.put("company_name", "Facebook");
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 1);
    }
    ...
    public void testWhereNotExists() throws IOException {
        ...
        assertEquals(new Recaudacion(csvHelper).where(options).size(), 0);
    }
    ...
    public void testWhereCorrectKeys() throws IOException {
        Map<String, String> options = new HashMap<String, String>();
        options.put("company_name", "Facebook");
        Map<String, String> row = new Recaudacion(csvHelper).where(options).get(0);
